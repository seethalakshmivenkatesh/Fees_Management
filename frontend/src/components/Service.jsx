...
const Service = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-[#EDE7F6] via-[#F3E5F5] to-[#EDE7F6] px-8 md:px-20 py-20 font-serif">
      <div className="text-center mb-14">
        <h2 className="text-4xl md:text-5xl font-serif text-[#4A148C] mb-4">
          Our Services
        </h2>
        <p className="text-[#2C2C2C] text-lg max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-white border border-[#E4DAF8] rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
          >
            <div className="text-4xl mb-4">{service.icon}</div>
            <h3 className="text-2xl font-semibold text-[#4A148C] mb-3">
              {service.title}
            </h3>
